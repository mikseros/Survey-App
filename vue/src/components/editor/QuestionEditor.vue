        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <button
                    ...
                    @click="addQuestion()"
                    class="
                        flex items-center text-xs py-1 px-3 mr-2 rounded-sm text-white
                ...
                <button
                    ...
                    class="
                        flex items-center text-xs py-1 px-3 rounded-sm border border-transparent
        ...
        <div class="grid gap-3 grid-cols-12">
            ...
            <div class="mt-3 col-span-3">
                ...
                <select
                    ...
                    @change="typeChange"
                    class="
                        mt-1 block w-full py-2 px-3 border border-gray-300 bg-white
            ...
            <div v-if="shouldHaveOptions()" class="mt-2">
                ...
                >
                    ...
                    <input
                        ...
                        @change="dataChange"
                        class="
                            w-full rounded-sm py-1 px-2 text-xs border border-gray-300
