    ...
    <PageComponent>
        ...
        <form @submit.prevent="saveSurvey">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center">
                            ...
                            class="
                                ...
                                "
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-[80%] w-[80%] text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <button
                                type="button"
                                class="
                                    relative overflow-hidden ml-5 bg-white py-2 px-3 border border-gray-300
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <h3 class="text-2xl font-sembibold flex items-center justify-between">
                        Questions
                        ...
                        <button
                            ...
                            @click="addQuestion()"
                            class="
                                flex items-center text-sm py-1 px-4 rounded-sm
...
// watch the current survey data change and when it happens, update local model
watch(
